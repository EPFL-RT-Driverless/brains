...
from brains_python.vision.yolo.utils.general import xywh2xyxy, xyxy2xywh
...
def plot_skeleton_kpts(im, kpts, steps, orig_shape=None):
    ...
    pose_kpt_color = palette[[16, 16, 16, 16, 16, 16, 16, 16]]
    radius = 1
...
def plot_images(
    ...
    for i, img in enumerate(images):
        ...
        if len(targets) > 0:
            ...
            # print(classes)
            labels = (
                image_targets.shape[1] == 2 * nkpt + 6
                if kpt_label
            ...
            for j, box in enumerate(boxes.T):
                ...
                if labels or conf[j] > conf_thresh:
